...
export function SetupCard({
  ...
  return (
    <div className="panel panel-hover group grain flex h-full flex-col p-5">
      ...
      <div className="relative my-4 flex h-52 items-center justify-center overflow-hidden rounded-lg bg-white/5 sm:h-44">
        ...
        <img
          ...
          width={768}
          height={768}
          className="relative z-10 h-40 w-auto object-contain transition-transform duration-500 group-hover:scale-110 sm:h-full"
        />
      </div>
